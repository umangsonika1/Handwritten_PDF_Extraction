...
# rgb_image = cv2.imread('/content/drive/MyDrive/Comer/CoMER/example/true.jpg')
#
# gray_image = cv2.cvtColor(rgb_image, cv2.COLOR_BGR2GRAY)
# _, black_white_image = cv2.threshold(gray_image, 127, 255, cv2.THRESH_BINARY)
#
# cv2.imwrite('/content/drive/MyDrive/Comer/CoMER/ans/true_gray_image.jpg', 255-gray_image)

# cv2.imwrite('/content/CoMER/ans/newoutput_black_white_image1.jpg', 255-black_white_image)


# import cv2
#
# image = cv2.imread('/content/drive/MyDrive/Comer/CoMER/ans/true_gray_image.jpg')
#
...
#
# cv2.imwrite('/content/drive/MyDrive/Comer/CoMER/ans/resized_gray_true_image.png', gray_resized_image)

# resized_gray_shape = gray_resized_image.shape
# print("Resized Grayscale Image shape:", resized_gray_shape)

# img = Image.open(r"C:\Users\Brigosha_Guest\PycharmProjects\pythonProject1\ans\resized_gray_true_image.png")
# # display(img)
...
def process_image(uploaded_file):
    ...
    for box, class_id in zip(pred_boxes, pred_classes):
        ...
        if class_id in [1]:
            ...
            # elements.append((cropped_img, (x1, y1)))

    # Sort elements based on the coordinates (leftmost and topmost first)
...
if uploaded_file is not None:
    ...
    if uploaded_file.type == "application/pdf":
        ...
        for idx, (cropped_img, text, _) in enumerate(elements, start=1):
            ...
            # rgb_image = cv2.imread(cropped_img)
